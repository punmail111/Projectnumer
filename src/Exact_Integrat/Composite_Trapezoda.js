...
class Composite_Trapezoda extends Component{
  ...
  data(){
    axios.get('http://192.168.99.101:8080/exact').then(res => {
      ...
      this.forceUpdate();
      this.Composite_Trapezoda(Number(this.state.x0),Number(this.state.xn),Number(this.state.n));
  ...
  Composite_Trapezoda(x0,x1,n){
    var fx0,fx1,h,error,x,fxall=0,xall;
    h = (x1-x0)/n;
    fx0=this.func(x0);
    fx1=this.func(x1);
  ...
  render(){
    ...
    return(
      ...
      <div className="Composite_Trapezoda">
        ...
        <br />
        <br />
        <h1 style={{textAlign:'center'}}>Composite Trapezoda Method</h1>
        <br />
